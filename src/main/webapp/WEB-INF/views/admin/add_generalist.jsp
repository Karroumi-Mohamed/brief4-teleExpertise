...
<head>
    ...
    <title>Add General Practitioner - TeleExpertise</title>
    <style>
...
<body>
    ...
    <div class="container">
        <div class="page-title"><h2>Add General Practitioner</h2></div>
        <p class="page-subtitle">Create a new general practitioner account</p>
        <c:if test="${not empty error}">
            <div class="error-message"><c:out value="${error}" /></div>
        </c:if>
        <form method="post" action="${pageContext.request.contextPath}/admin/generalists/add">
            <div class="form-grid">
                <div class="form-row">
                    <div class="form-field">
                        <label for="firstName">First Name</label>
                        <input type="text" id="firstName" name="firstName" required value="${param.firstName}" placeholder="John">
                    </div>
                    <div class="form-field">
                        <label for="lastName">Last Name</label>
                        <input type="text" id="lastName" name="lastName" required value="${param.lastName}" placeholder="Doe">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-field">
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" required value="${param.email}" placeholder="doctor@hospital.com">
                    </div>
                    <div class="form-field">
                        <label for="phone">Phone</label>
                        <input type="tel" id="phone" name="phone" required value="${param.phone}" placeholder="+1234567890">
                    </div>
                </div>
            ...
            <div class="form-actions">
                <button type="submit" class="submit-btn">Add Generalist</button>
