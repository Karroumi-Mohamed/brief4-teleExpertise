...
<body>
    ...
    <div class="container">
        ...
        <p class="page-subtitle">Patients waiting for consultation with general practitioner</p>
        ...
        <c:choose>
            <c:when test="${empty waitingQueue}">
                <div class="empty-state">
                    ...
                    <a href="${pageContext.request.contextPath}/nurse/patients/register" class="action-link">Register a patient →</a>
                </div>
            </c:when>
            <c:otherwise>
